                        ...
                        <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 d-flex justify-content-center position-relative">
                            <div class="show-case">
                                <div class="hero-slide-image">
                                    <img src="{{asset('uploads/banner_photo')}}/{{$banner->banner_images}}" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="section-title text-center mb-0">
                    ...
                    <div class="nav-center">
                        <ul class="product-tab-nav nav align-items-center justify-content-center">
                            ...
                            @foreach($category_item as $categories)
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-product-{{$categories->id}}">{{$categories->category_name}}</a>
                            </li>
                            @endforeach
        ...
        <div class="row">
            <div class="col">
                <div class="tab-content mb-30px0px">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        ...
                                        <span class="badges">
                                            @if(Carbon\Carbon::parse($product->created_at)->diffInDays() <=3) <span class="new">New</span>
                                        @endif
                                        @if($product->new_price)
                                        <span class="sale">{{round(100-($product->new_price/$product->old_price)*100)}}%</span>
                                        @endif
                                        </span>
                                        <div class="actions">
                    ...
                    <!-- 2nd tab start -->
                    @foreach($category_item as $categories)
                    <div class="tab-pane fade" id="tab-product-{{$categories->id}}">
                        <div class="row">
                            @foreach(App\Models\Product::where('category_id',$categories->id)->get() as $product)
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up" data-aos-delay="200">
                                <!-- Single Prodect -->
                                <div class="product">
                                    <div class="thumb">

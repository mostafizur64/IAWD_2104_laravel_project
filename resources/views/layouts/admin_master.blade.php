                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                <div class="nav-user-info">
                                    ...
                                    <span class="status"></span><span class="ml-2">loging </span>
                                </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <a class="nav-link" href="{{route('/')}}" target="_blank"><i class="fas fa-home"></i>visit site</a>


                            <li class="nav-item ">
                                <a class="nav-link active" href="" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fa fa-fw fa-align-center"></i>Categoy <span class="badge badge-success">6</span></a>
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('category.createCategory')}}" data-toggle="" aria-expanded="" data-target="#submenu-1-2" aria-controls="submenu-1-2">Add Category</a>

                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('category.index')}}" data-toggle="" aria-expanded="false" data-target="#submenu-1-3" aria-controls="submenu-1-3">View Category</a>

                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('category.trashed')}}" data-toggle="" aria-expanded="false" data-target="#submenu-1-4" aria-controls="submenu-1-4">View Trashed</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i>SubCategroy</a>
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('subcategoy.create')}}">Add SubCategory</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('subcategory.index')}}">View SubCategory</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('subcategory.trashed')}}">View Trashed</a>
                                        </li>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fab fa-fw fa-wpforms"></i>Banner</a>
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('banner.create')}}">Banner Add</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{route('banner.index')}}">Banner View</a>
                                        </li>
